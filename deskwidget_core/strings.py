...
STRINGS = {
    "ja": {
        ...
        "no_match": "該当する配信はありません",
        "search_hint": "番組タイトルで絞り込み (入力するたびに反映)",
        "count_filtered": "該当 {shown}件 / 配信中 {live}人",
        "clear_filter": "絞り込みを解除",
        "dark_mode": "ダークモード",
        "light_mode": "ライトモード",
        "theme_color": "テーマカラー",
        "font_family": "フォント",
    ...
    "en": {
        ...
        "no_match": "No streams match the filter",
        "search_hint": "Filter by stream title (updates as you type)",
        "count_filtered": "{shown} matched / {live} live",
